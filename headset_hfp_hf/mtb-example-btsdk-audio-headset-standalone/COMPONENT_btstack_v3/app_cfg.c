...
const wiced_bt_cfg_br_t wiced_bt_cfg_br =
{
    ...
    .device_class = {0x04, 0x04, 0x24},                     /**< Local device class: Audio/Video, wearable headset */
...
#ifdef WICED_APP_AUDIO_SRC_INCLUDED
    // HF role uses the shared audio define, but should advertise A2DP Sink to the phone.
